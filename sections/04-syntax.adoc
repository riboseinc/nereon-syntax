...
|TAB  |9   |Separates keys and values in a table and surrounds infox operators
...
|`\`  |92  |Indicates an exscape sequence
|===
...
braces (`[]` ASCCI 91/93). Within the braces are zero or more values
